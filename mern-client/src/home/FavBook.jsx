  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
        <div className='md:w-1/2'>
         ...
         <p className='mb-10 text-lg md:w-5/6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi placeat doloremque laudantium asperiores praesentium nulla voluptates aut quos, porro deserunt corrupti quibusdam debitis commodi ab dolorem quod!</p>
       {/* stats */}
